...
% searchdata = detrend(searchdata); % detrends and normalizes mean to zero
searchdata = searchdata - mean(searchdata); % mean-centers data without removing underlying trends
